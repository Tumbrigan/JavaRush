    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                StringBuilder stringBuilder = new StringBuilder(" лает гав! ");
                int index = stringBuilder.lastIndexOf("а");

                for (int j = 0; j < i - 1; j++) {
                    stringBuilder.insert(index, "а");
                }

                return getName() + stringBuilder + formatter.format(new Date());
            }
